...
# forward now" (docs/adr/2026-09-14-ntfy-pages-only-when-nothing-can-proceed-without-a-human.md).
...
# Where the topic lives is project config, not a literal here (docs/adr/2026-09-14-the-agent-
